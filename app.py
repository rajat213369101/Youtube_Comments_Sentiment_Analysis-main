...
def index():
    try:
        if request.method == 'POST':
            ...
            data = fetch_video_comments_and_info(youtube_url)
            print("📦 Data fetched:", data)

            if not data or not data['comments']:
                print("⚠️ No comments found or invalid video.")
                return render_template('index.html', error="No comments found or invalid video.")

            sentiments = analyze_comments_multiprocess(data['comments'])
